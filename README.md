...
_ПРОСТЫЕ БАЗОВЫЕ_ (числовые, символьные, логические, перечисление, интервал, указатели)
_СТАТИЧЕСКИЕ_ (вектор, массив, множество, запись, таблица)
_ПОЛУСТАТИЧЕСКИЕ_ (стек, очередь, дек, строка)
_ДИНАМИЧЕСКИЕ_ (связный список, граф, дерево)
...
### Ассоциативный массив (associative array, map, symbol table, dictionary)
