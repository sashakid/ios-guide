...
Например, числа: натуральные, целые, вещественные; литеры, строки и т. д. 
В языке СИ: `int`, `float`, `char`. 
