- [Общие вопросы](#общие-вопросы)
	...
	- [Что такое назначенный инициализатор, напишите любой элементарный инициализатор, почему он так выглядит?](#назначеный-инициализатор)
	...
	- [NSArray arrayWithObjects: a, b, c, nil; зачем nil в конце?](#nsarray-зачем-nil-в-конце)
	...
	- [Как работает code signing?](#code-signing)
	- [Как проводить код ревью?](#code-review)
