...
•	Зачем нужен: если ты хочешь подстроить какие-то вещи на основе уже рассчитанных фреймов — например, сделать округление углов у view с шириной, которую раньше ты не знал.
